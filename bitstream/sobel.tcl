...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins sobel_filter_0/s_axi_Ctrl_Bus]
  connect_bd_intf_net -intf_net sobel_filter_0_m_axi_Data_Bus [get_bd_intf_pins axi_smc/S00_AXI] [get_bd_intf_pins sobel_filter_0/m_axi_Data_Bus]
  connect_bd_intf_net -intf_net sobel_filter_0_m_axi_Data_Bus1 [get_bd_intf_pins axi_smc/S01_AXI] [get_bd_intf_pins sobel_filter_0/m_axi_Data_Bus1]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins sobel_filter_0/ap_rst_n]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs sobel_filter_0/s_axi_Ctrl_Bus/Reg] SEG_sobel_filter_0_Reg
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces sobel_filter_0/Data_m_axi_Data_Bus] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces sobel_filter_0/Data_m_axi_Data_Bus1] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
